...
if heating != 'Electricity':
    improve.append('Consider switching to electric heating.')
...
if energy_efficiency != 'Yes':
    improve.append('Consider the energy efficiency of your devices more.')
...
if 'Stove' or 'Oven' or 'Grill' in cook:
    improve.append('Consider cooking more with an air fryer or microwave where possible.')
